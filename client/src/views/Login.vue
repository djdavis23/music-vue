            ...
            <div id="control-panel" class="col-md-6 col-xs-12">
              ...
              <form class="form-inline" v-if="loginForm" @submit.prevent="loginUser">
                ...
                <input type="password" class="form-control-lg mb-2" name="password" placeholder="Enter your password" v-model="password"
                  required /><br>
                <button type="submit" class="btn btn-primary btn-block mt-2 mb-2" id="get-music-button">Login</button>
              </form>
              <form class="form-inline" v-if="!loginForm" @submit.prevent="registerUser">                
                  <input type="text" class="form-control mt-2 mb-2 mr-2" name="username" placeholder="Enter User Name" v-model="userName" required /><br>
                  <input type="password" class="form-control mb-2 mr-2" name="password" placeholder="Enter a password" v-model="password" required /><br>
                  <input type="password" class="form-control mb-2 mr-2" name="password-confirm" placeholder="Confirm password" v-model="passwordConfirm"
                    required /><br>
                  <button type="submit" class="btn btn-primary mt-2 mb-2" id="get-music-button">Register</button>
               </form>
            </div>
          </div>
    </div>
